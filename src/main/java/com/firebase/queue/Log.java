...
public class Log {
    public interface Logger {
        ...
        void log(String log, DatabaseError error);

        void debug(String log, DatabaseError error);
    ...
    public static void log(String log, DatabaseError error) {
        instance.log(log, error);
    }

    public static void debug(String log, DatabaseError error) {
        if (instance.shouldLogDebug(Level.ERROR)) {
            instance.debug(log, error);
        }
    }
    ...
    private static class DefaultLogger implements Logger {
        ...
        @Override
        public void log(String log, DatabaseError error) {
            System.err.println(ANSI_RED + getDateTimeStamp() + " [ERROR] " + log);
        ...
        @Override
        public void debug(String log, DatabaseError error) {
            System.err.println(ANSI_RED + getDateTimeStamp() + " [DEBUG] " + log);
            System.err.println("\tcode=" + error.getCode() + " message=" + error.getMessage() + " details=" + error.getDetails());
            System.err.println(ANSI_RESET);
        }
