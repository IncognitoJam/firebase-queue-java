...
public class QueueExecutor extends ThreadPoolExecutor {
    ...
    public QueueExecutor(int numWorkers) {
        this(numWorkers, numWorkers, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>());
    }

    public QueueExecutor(int corePoolSize, int maximumPoolSize) {
        this(corePoolSize, maximumPoolSize, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>());
    }
    ...
    void setTaskStateListener(Queue.TaskStateListener taskStateListener) {
